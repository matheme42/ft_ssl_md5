...
/*   Updated: 2021/07/02 12:09:52 by matheme          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static void md5_output(char *name, t_h h)
{
...
void md5(char *file, unsigned long file_len, char *name)
{
    int     new_len;
    int     offset;
    uint8_t *msg;
